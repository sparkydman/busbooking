                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="name">Travelling From</label>
                                        <input id="name" name="Tfrom" type="text" placeholder="Departure Terminal" class="form-control input-md">
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="email">Travelling To</label>
                                        <input id="email" name="Tto" type="text" placeholder="Arrival Terminal" class="form-control input-md">
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="date" name="date" type="date" placeholder="Select Date" class="form-control input-md">
                                    </div>
                                </div>
                                <!-- Select Basic -->
                                <div class="col-md-6">
